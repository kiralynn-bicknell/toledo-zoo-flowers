...
var style_ToledoZooFlowerAnnex_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        function rules_ToledoZooFlowerAnnex_1(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_ToledoZooFlowerAnnex_1rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_ToledoZooFlowerAnnex_1rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 6.8 + size,
        ...
        var style = rules_ToledoZooFlowerAnnex_1(feature, value);
        ;

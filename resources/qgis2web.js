...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-9304616.604931, 5103778.393429, -9304051.820222, 5104400.392180],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-9304838.188239, 5103712.709763, -9303527.160540, 5104394.968140], map.getSize());
